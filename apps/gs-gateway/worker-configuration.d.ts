/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bb91a1dbe0ac912a236981b745db29fa)
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		CLOUDFLARE_TEAM_DOMAIN: "gsl-ops";
		API: Fetcher /* gs-api */;
	}
	interface ProdEnv {
		GATEWAY_KV: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV" | "API_ORIGIN" | "CLOUDFLARE_ACCESS_AUDIENCE" | "CLOUDFLARE_TEAM_DOMAIN">> {}
}
