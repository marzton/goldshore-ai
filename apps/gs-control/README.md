...
5. Rerun the affected GitHub Actions workflows, then run `.github/workflows/sync-infra.yml` to verify the rotated credentials can still reconcile Cloudflare state.
