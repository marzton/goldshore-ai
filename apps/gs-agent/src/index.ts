  ...
  async fetch(
    ...
    if (url.pathname === '/templates') {
      return Response.json({
        service: 'gs-agent',
        description:
          'Agent templates for HITL workflows, AI orchestration, and ops automation.',
        modules: [
          {
            name: 'operator-assist',
            purpose:
              'Human-in-the-loop review queues for approvals, escalations, and audits.',
          },
          {
            name: 'ai-routing',
            purpose:
              'Route prompts to Gemini, ChatGPT, Jules, or internal models.',
          },
          {
            name: 'market-intel',
            purpose:
              'Fuse Alpaca, Thinkorswim, and internal signals for market operations.',
          },
        ],
        nextSteps: [
