...
function getModalTemplate(variant: string): string {
  ...
  return `
    ...
    <form class="gs-form" action="/api/contact" method="POST">
      ...
      <div style="position:absolute;left:-9999px;opacity:0;pointer-events:none;" aria-hidden="true">
        <label class="gs-label" for="gs-company-website">Company website</label>
        <input class="gs-input" id="gs-company-website" name="companyWebsite" type="text" autocomplete="off" tabindex="-1" />
      </div>
      <label class="gs-label">Email</label>
      <input class="gs-input" name="email" type="email" autocomplete="email" required />
