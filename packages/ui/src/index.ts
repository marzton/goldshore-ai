...
// Alias for compatibility if needed, or remove GSButton usage
export { default as GSButton } from '../components/Button.astro';
...
export { default as SharedHeader } from '../components/SharedHeader.astro';
