...
2.  **Create a New Branch**:
    ...
    ```
3.  **Port Changes**: Manually copy _only_ the unique source files (e.g., new components, logic) from your old branch to the new structure in `apps/web/`, `apps/admin/`, etc.
